...
function Tradestart() {
  ...
  return (
    <div>
      <div className="container row">
        <div className="col-md-12 col-sm-12 col-12">
          ...
          <div className="jumbotron" style={{ textAlign: "center" }}>
            <p>
              For execution of the deal,one member from team A has to INITIATE
              THE TRADE by proceeding with generation of code on the portal.
              Team B has to enter the one-time trading code, along with
              offerings and receivings of the components or currency of each
              teams, on SEND TRADE OFFER USING A CODE.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="view zoom">
        <Link
          className="btn active or"
          style={{ marginBottom: "10vh !important", border: "none" }}
        >
          <span>OR</span>
        </Link>
      </div>
